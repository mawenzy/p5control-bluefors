...
from core.widgets import SweeperControl2, AddawinControl
...
class BlueForsGUIMainWindow(QMainWindow):
    ...
    def init_widgets(self):
        ...
        # self.sweeper2_control = SweeperControl2(self.gw)
        self.addawin_control = AddawinControl(self.gw)
    ...
    def init_docks(self):
        ...
        # self.sweeper2_control_dock = QDockWidget('Sweeper2 control', self)
        # self.sweeper2_control_dock.setMinimumWidth(MIN_DOCK_WIDTH)
        # self.sweeper2_control_dock.setWidget(self.sweeper2_control)

        self.addawin_control_dock = QDockWidget('ADwin Control', self)
        self.addawin_control_dock.setMinimumWidth(MIN_DOCK_WIDTH)
        self.addawin_control_dock.setWidget(self.addawin_control)

        # add dock widgets
        self.addDockWidget(Qt.LeftDockWidgetArea, self.tree_dock)
        self.addDockWidget(Qt.RightDockWidgetArea, self.measurement_control_dock)
        # self.addDockWidget(Qt.RightDockWidgetArea, self.sweeper2_control_dock)
        self.addDockWidget(Qt.RightDockWidgetArea, self.addawin_control_dock)
        ...
        self.view_menu.addActions([
            ...
            # self.sweeper2_control_dock.toggleViewAction(),
            self.addawin_control_dock.toggleViewAction(),
