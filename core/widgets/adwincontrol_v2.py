...
class AdwinControl_v2(QWidget):
    ...
    def __init__(
        ...
        self.amplitude = SpinBox(value=self.gw.adwin.amplitude, bounds=[0,10])
        self.frequency = SpinBox(value=self.gw.adwin.frequency, bounds=[0,5])
        self.lockin_amplitude = SpinBox(value=self.gw.adwin.lockin_amplitude, bounds=[0,10])
        self.lockin_frequency = SpinBox(value=self.gw.adwin.lockin_frequency, bounds=[0,10000])
    ...
    def _handle_frequency(self):
        self.gw.adwin.setFrequency(float(self.frequency.value()))

    def _handle_lockin_amplitude(self):
        self.gw.adwin.setLockinAmplitude(float(self.lockin_amplitude.value()))

    def _handle_lockin_frequency(self):
        self.gw.adwin.setLockinFrequency(float(self.lockin_frequency.value()))
