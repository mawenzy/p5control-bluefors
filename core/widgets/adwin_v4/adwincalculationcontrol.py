...
class Adwinv4CalculationControl(QWidget):
    """
    ...
    def __init__(
        ...
        self.status_label.setText("Calculations:")
        ...
        self.current_threshold_label.setText("Threshold: (A)")
        ...
        layout.addWidget(self.current_threshold_label, 1, 0)
        layout.addWidget(self.current_threshold, 1, 1, 1, 2)
