...
class AdwinSweepControl(QWidget):
    """
    ...
    def __init__(
        ...
        self.frequency = SpinBox(value=self.gw.adwin.getFrequency(), bounds=[0, 10])
        ...
        layout.addWidget(self.frequency_label, 2, 0, 1, 2)
        layout.addWidget(self.frequency, 2, 2)
