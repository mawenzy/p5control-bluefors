...
class FemtoDLPVA100B_BA(BaseDriver):
    """
    CHANGED a TO b
    """
    ...
    def get_status(self):
        ...
        return {
            ...
            "overload_A": self.femtoThread.overload_B,
            "overload_B": self.femtoThread.overload_A,
            "dc": self.dc,
    ...
    def get_data(self):
        ...
        return {
            "time": list(times),
            "overload_A": list(overload_B),
            "overload_B": list(overload_A),
        }
